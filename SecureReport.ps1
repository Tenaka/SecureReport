...
################################################
    ...
    $frag_NeverExpires = $fragNeverExpires | ConvertTo-Html -as Table -Fragment -PreContent "<p></p><details><summary><a name=`"PassExpire`"><a href=`"#TOP`">Domain Accounts that Never Expire their Password</summary><p>" -PostContent "<h4>$descripToDo</h4></details>"  | Out-String
